...
const OPERATOR_NAME = "PJM";
const CONTACT_EMAIL = "nexstep06@cdsai.kr";
    ...
    <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
      ...
      <section id="s1" className="mb-10 scroll-mt-20">
        ...
        <ol className="list-decimal space-y-2 pl-6 leading-relaxed">
          ...
          <li>
            <strong>고충 처리</strong>
            <br />
            정보주체의 문의사항 확인 및 사실조사를 위한 연락·통지, 처리결과
            통보 목적으로 개인정보를 처리합니다.
          </li>
        </ol>
      </section>
      ...
      <section id="s5" className="mb-10 scroll-mt-20">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          처리업무를 위탁하고 있습니다. 모든 위탁 업체는 대한민국(Seoul)
          리전에서 개인정보를 저장·처리하고 있습니다.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border text-sm">
            <thead className="bg-gray-50">
      ...
      <section id="s6" className="mb-10 scroll-mt-20">
        ...
        <p className="leading-relaxed">
          ...
          로 서면, 이메일 등을 통하여 하실 수 있으며 {SERVICE_NAME}은 이에
          대해 지체 없이 조치하겠습니다.
        </p>
      </section>
      ...
      <section id="s7" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
            <strong>기술적 조치</strong>: 접근 권한 관리, 비밀번호 단방향
            암호화 저장, HTTPS 통신 암호화, Row Level Security(RLS) 적용
          </li>
          <li>
      ...
      <section id="s8" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
            <strong>사용 목적</strong>: 로그인 세션 유지, 이용자 환경 설정
            저장
          </li>
          <li>
            <strong>거부 방법</strong>: 웹브라우저 설정 &gt; 개인정보 보호
            및 보안 메뉴에서 쿠키 저장을 거부할 수 있습니다. 다만, 쿠키
            저장을 거부할 경우 로그인이 필요한 일부 서비스 이용에 어려움이
            있을 수 있습니다.
          </li>
        </ul>
      </section>
